...
class Dictionary:
    ...
    def dict_csv(self, code):
        ...
        if code == "one letter code":
            codes_db = pd.read_csv("py-resources/PepToCodes/resources/codes.csv", sep=' ', names=['name', 'smiles', '3lcode', '1lcode'], 
    ...
    def dict_json(self, canonical=True, isomeric=False):
        ...
        if canonical is True:
            with open("py-resources/PepToCodes/resources/norineDB.json", "r") as r:
                data = json.load(r)
